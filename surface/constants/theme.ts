...
export const theme = {
  ...
  // ── Status ──────────────────────────────────────────────────────────────
  // What the AGENT is doing. Color owns the dot. Thinking = pulse animation
  // on whatever priority color the card already has, not its own color.
  //
  //   idle         GRAY    quiet, not doing anything
  //   thinking     GRAY    working — dot pulses to show activity
  //   needs-input  GRAY    waiting for you (priority color handles importance)
  //   failed       RED     something broke
  // ─────────────────────────────────────────────────────────────────────────
  status: {
    idle:          { tint: undefined as string | undefined, dot: "rgba(0,0,0,0.18)" },
    thinking:      { tint: undefined as string | undefined, dot: "rgba(0,0,0,0.18)" },
    "needs-input": { tint: undefined as string | undefined, dot: "rgba(0,0,0,0.18)" },
    failed:        { tint: "rgba(255,59,48,0.10)",          dot: "#FF3B30"           },
  },

  // ── Priority ──────────────────────────────────────────────────────────
  // What matters to YOU. Priority owns the color on the glass pill.
  //
  //   important    BLUE     #007AFF
  //   urgent       AMBER    #FF9F0A
  //   both         split    blue + amber gradient
  //   neither      no tint  (default glass)
  // ─────────────────────────────────────────────────────────────────────────
  priority: {
    important: { tint: "rgba(0,122,255,0.12)",   dot: "#007AFF" },
    urgent:    { tint: "rgba(255,159,10,0.12)",   dot: "#FF9F0A" },
    both:      { tint: "split", dot: "#007AFF" },
  },
  ...
  timeOfDay: {
    morning:   { top: "hsl(25,30%,89%)",  base: "hsl(30,8%,93%)" },   // sunrise — coral-pink
    midday:    { top: "hsl(200,12%,91%)", base: "hsl(30,6%,94%)" },   // clear sky — warm neutral
    ...
    night:     { top: "hsl(220,12%,87%)", base: "hsl(30,5%,92%)" },   // deep focus — warm base
  },
